...
uint8_t const hid_report_descriptor[] = {
    ...
    /* Report ID if any */
    HID_REPORT_ID(REPORT_ID_MOUSE) HID_USAGE(HID_USAGE_DESKTOP_POINTER),
    ...
    HID_LOGICAL_MIN_N(0x8001, 2), HID_LOGICAL_MAX_N(0x7fff, 2),
    HID_REPORT_COUNT(2), HID_REPORT_SIZE(16),
    HID_INPUT(HID_DATA | HID_VARIABLE | HID_RELATIVE),
    /* Verital wheel scroll [-32767, 32767] */
    HID_USAGE(HID_USAGE_DESKTOP_WHEEL), HID_LOGICAL_MIN_N(0x8001, 2),
    HID_LOGICAL_MAX_N(0x7fff, 2), HID_REPORT_COUNT(1), HID_REPORT_SIZE(16),
    HID_INPUT(HID_DATA | HID_VARIABLE | HID_RELATIVE),
    HID_USAGE_PAGE(HID_USAGE_PAGE_CONSUMER),
    /* Horizontal wheel scroll [-32767, 32767] */
    HID_USAGE_N(HID_USAGE_CONSUMER_AC_PAN, 2), HID_LOGICAL_MIN_N(0x8001, 2),
    HID_LOGICAL_MAX_N(0x7fff, 2), HID_REPORT_COUNT(1), HID_REPORT_SIZE(16),
